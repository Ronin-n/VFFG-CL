...
cmd="python train_VFFGN.py --dataset_mode=multimodal_miss --model=VFFGN_base
...
--ce_weight=1.0 --mse_weight=8.0 --cl_weight=10 --consistent_weight=100
...
--name=CAP_VFFGN_base --suffix=block_{n_blocks}_run_{gpu_ids}_{run_idx} --has_test --early_stage_epochs=20
